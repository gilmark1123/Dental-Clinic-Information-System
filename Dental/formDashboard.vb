...
Public Class formDashboard
    ...
    End Sub
    Private Sub formDashboard_Paint(sender As Object, e As PaintEventArgs) Handles MyBase.Paint
        Dim mistyrose As Color = Color.MistyRose ' LightPink color
        Dim lightPinkColor As Color = Color.FromArgb(255, 255, 210, 215)

        Dim gradientBrush As New LinearGradientBrush(New Point(0, Me.Height), New Point(0, 0), lightPinkColor, mistyrose)
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If _formHomeInstance IsNot Nothing Then
            Dim idValueFromHomeForm As Integer = _formHomeInstance.IDValueFromHomeForm

            Try
                DatabaseManager.OpenConnection()
                Dim connection As MySqlConnection = DatabaseManager.GetConnection()

                Dim query As String = "SELECT * FROM account WHERE idaccount =" & idValueFromHomeForm & ""
                Using cmd As New MySqlCommand(query, connection)
                    Using reader As MySqlDataReader = cmd.ExecuteReader()
                        If reader.Read() Then
    ...
    Private Sub Panel4_Paint(sender As Object, e As EventArgs) Handles Panel4.Click
        formHome.CallBtnAppointmentsClick()
    End Sub



    Private Sub Panel5_Paint(sender As Object, e As EventArgs) Handles Panel5.Click
    ...
    Private Sub Panel6_Paint(sender As Object, e As EventArgs) Handles Panel6.Click
        formHome.CallBtnAppointmentsClick()
    End Sub
